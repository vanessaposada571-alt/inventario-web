    ...
    public partial class AddPhoneAndAddressToCustomer : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A0B15157430", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CD7BC6EAFE", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK__Products__Catego__5EBF139D",
